...
The data services consist of the ontology-based knowledge graph and the article database.
...
modules in this are only thin wrappers around the integrations layer.  
...
Both user and feedback follow the same layered structure as the recommendation logic, 
