...
\begin{lstlisting}[caption={[Method template]The random forest template for classification, which extends the base template and overrides its blocks.}, label={lst:method-template}]
