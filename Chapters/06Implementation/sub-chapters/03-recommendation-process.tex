...
based on the filter values the user has selected. In the second stage, 
...
only for feedback as described in Section~\ref{sec:feedback-boost}. 
...
on the articles that mention it. 
Combining rank positions from both stages gives weight to both 
...
Using only the cross-encoder score is also possible, and was the initial approach. 
