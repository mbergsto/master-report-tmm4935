...
the tasks associated with them, then presents a selection of common 
methods and some attributes that distinguish them. Neural networks and 
deep learning are treated separately. The section closes with a review 
of existing approaches to method selection.
