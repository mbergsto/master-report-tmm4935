...
This reflects the nature of many industrial problems, where labelled data is available 
...
article abstracts across product lifecycle (PLC) phase, application area, learning paradigm,
...
The analysis confirmed the paradigm distribution described above: 
