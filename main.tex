...
\usepackage[lmargin=1in, 
    ...
    tmargin=1in, 
    bmargin=1in]
    {geometry} %sets the margins for the pages
...
\usepackage[hidelinks]{hyperref} %to make hyperlinks in the pdf, for example in the table of contents, and to manage the look of links
\usepackage[backend = biber,
            ...
            sortcites = true,   % sort multiple citations in the same \cite{} command
...
\usepackage{longtable} %to make tables that span multiple pages
\usepackage{xltabular} 
\usepackage{csquotes} %to manage quotations, and to make it possible to use the \enquote{} command for quotes that automatically adjust to the language (e.g. " in English, « in French etc.)
...
\lstset{
    ...
    columns=flexible,        % ikke fixed-bredde
    keepspaces=true,         % bevar mellomrom som de er
    upquote=true,            % ' blir ikke til ´
    literate={--}{{-{}-}}2   % ikke konverter -- til en lang strek
             {-}{{-}}1
}
...
\noindent \textbf{\Large MLguide: Decision Support} \\
\noindent \textbf{\Large for Machine Learning Method Selection} \\
\noindent \textbf{\Large in Product Development and Production} \\
\vspace{0.5cm}

\noindent {\large Combining Ontology-Based Knowledge, Semantic} \\
\noindent {\large Literature Retrieval, and Implementation Support} \\
...
\markboth{Declaration of AI Use}{Declaration of AI Use}
\addcontentsline{toc}{chapter}{\protect\numberline{}Declaration of AI Use}
\input{Chapters/10Declaration-AI-Use.tex}
\cleardoublepage
